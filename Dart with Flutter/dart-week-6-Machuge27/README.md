...
- **Welcome Message**: Use a Text widget to display a welcome message centered in the UI.
- **Styled Container**: Create a Container widget that serves as a visually appealing background for your welcome message. Style the container using properties like color, borderRadius, and padding.
